...
func (closeSchedulingEntityType) EncodeEntity() string { return "fern:close_scheduling_entity" }
...
func (taskTestEntityType) EncodeEntity() string { return "fern:test_entity" }
