...
type ClientData struct {
	...
	// WaterdogIP is the IP address of the player when behind a Waterdog proxy.
	WaterdogIP string `json:"Waterdog_IP,omitempty"`
	// WaterdogXUID is the XUID of the player when behind a Waterdog proxy.
	WaterdogXUID string `json:"Waterdog_XUID,omitempty"`
}
