module github.com/Origin-Net/FernMC/plugin-src/Minigames

go 1.26.0

require (
	github.com/Origin-Net/FernMC v1.0.0
...
replace github.com/Origin-Net/FernMC => /home/wak/dragonfly

replace github.com/sandertv/gophertunnel => /home/wak/dragonfly/lib/gophertunnel
